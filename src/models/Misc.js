...
const leaveSchema = new mongoose.Schema(
  {
    ...
    leaveType: {
      type: String,
      enum: ["sick", "casual", "earned", "medical", "personal", "other"],
      required: true,
    },
...
// Holiday / Institution Calendar Event
const calendarEventSchema = new mongoose.Schema(
  {
    ...
    type: {
      type: String,
      enum: ["holiday", "event", "exam", "ptm", "weekend", "festival", "other"],
      required: true,
    },
    ...
    targetRoles: [
      {
        type: String,
        enum: ["all", "principal", "teacher", "student", "parent"],
      },
    ],
